...
AIGC:
  ...
  Label: '1'
  ProduceID: '23e89481-0bee-47df-a797-d0b96eaa2e2c'
  PropagateID: '23e89481-0bee-47df-a797-d0b96eaa2e2c'
  ReservedCode1: '10f36883-1636-42f0-83f8-4d49d8e57d8f'
  ReservedCode2: '10f36883-1636-42f0-83f8-4d49d8e57d8f'
---
...
- **云电脑 / 云手机保活**：周期性连接保活，支持保活间隔/开关的面板热配置；自动保活账号下全部 D 开头云电脑与 M 开头云手机设备（日志中按 D/M 前缀区分）
...
**Q3：云手机有没有被保活？**
保活核心会自动保活账号下全部设备：日志中 `D` 开头的设备码为云电脑、`M` 开头为云手机，两者都会周期性连接并保活。面板「运行日志」页切换到**保活日志**分类即可看到两类设备记录。
