...
(function () {
  const P = {
    ...
    // 密码可见切换（2026-09-07 修复：改密弹窗眼睛按钮此前在图标库中无定义，
    // 渲染为空白按钮；补 Lucide 风格描边眼睛图标，与整体线条风格一致）
    'eye-outline': { s: '<path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12z"/><circle cx="12" cy="12" r="3"/>' },
    'eye-off-outline': { s: '<path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"/><path d="M1 1l22 22"/>' }
  };
